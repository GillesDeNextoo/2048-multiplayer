document.addEventListener("DOMContentLoaded", function () {
  	...
  	var sockjs_url = 'http://de702.ispfr.net:3000/game/sockets', sockjs, multiplexer;
	 	...
	 	var startNewGame = function () {
	 		...
	 		$('#game-start-btn').on('click', function () {
				...
				userNumInterval = setInterval(function () {
					$.get('http://de702.ispfr.net:3000/game/players', function (data) {
						...
						$('#player-msg').removeClass('text-center');	
				   		...
				   		if (times === -1) {
				    		...
				    		var gameOver = function (timer, message, connectionIssue) {
				   			...
				   			var gameTimeLeft = 320;//game timer
